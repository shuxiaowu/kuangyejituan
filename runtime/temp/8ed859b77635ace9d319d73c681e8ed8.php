<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"D:\phpStudy\PHPTutorial\WWW\kuangye/app/home\view\index\about.tpl";i:1553313822;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\common.tpl";i:1553325227;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\header.tpl";i:1553328798;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\inside.tpl";i:1553239675;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\footer.tpl";i:1553243640;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
			...
			<form action="<?php echo url('Index/search'); ?>" method="post" name="myform">
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button class="btn btn-default seachbtn" name="btn-submit" value="搜索" type="submit" style="background:#ed1515"><span class="glyphicon icon-sousuo" aria-hidden="true"></span></button>
					</span>
				</div>
		</div>
	</div>
...
<div class="mainbox">
	<div class="main fixed">
		<div class="left leftnav wow fadeInLeft animated">
					...
					<div class="panel-group" id="accordion">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									...
									联盟介绍<img src="/kuangye/public/home/images/arrow-right.png">
								</a>
							</h4>
						</div>
						<div id="collapseOne" class="panel-collapse collapse">
							<?php if(is_array($datatype) || $datatype instanceof \think\Collection || $datatype instanceof \think\Paginator): $i = 0; $__LIST__ = $datatype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
								<div class="panel-body <?php if($Id == $obj['Id']): ?>active<?php endif; ?>">
									<a href="<?php echo url('Index/about','Id='.$obj['Id']); ?>"><?php echo $obj['topic']; ?></a>
								</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								...
								联盟新闻<img src="/kuangye/public/home/images/arrow-right.png">
							</a>
						</h4>
					</div>
				</div>
				<div id="collapseTwo" class="panel-collapse collapse">
					<?php if(is_array($aboutnews) || $aboutnews instanceof \think\Collection || $aboutnews instanceof \think\Paginator): $i = 0; $__LIST__ = $aboutnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
						<div class="panel-body <?php if($Id == $obj['Id']): ?>active<?php endif; ?>">
							<a href="<?php echo url('Index/about','Id='.$obj['Id']); ?>"><?php echo $obj['topic']; ?></a>
						</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<?php if(is_array($aboutother) || $aboutother instanceof \think\Collection || $aboutother instanceof \think\Paginator): $i = 0; $__LIST__ = $aboutother;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
			<div class="panel-group" id="accordion">
				<div class="panel panel-default">
					<div class="panel-heading <?php if($Id == $obj['Id']): ?>active<?php endif; ?>">
						<h4 class="panel-title">
							<a href="<?php echo url('Index/about','Id='.$obj['Id']); ?>">
								<?php echo $obj['topic']; ?>
							</a>
						</h4>
					</div>
	...
	<div class="sideContactBox">
		...
		<div class="right-con wow fadeInUp animated">
			<div class="path">
				...
				<div class="pathdiv"> <a href="<?php echo url('Index/index'); ?>">主页</a><span>&gt;</span><a href="">关于联盟</a><span>&gt;</span><a href="" class="on"><?php echo $title; ?></a></div>
			</div>
			<div class="rightBox">
...
<script type="text/javascript">
	$(function(){
		if($('#collapseOne').hasClass('in')){
			...
			$('#accordion .panel-title a').children('img').attr("src","/kuangye/public/home/images/arrow-down.png");
		}
		else{
			$('#accordion .panel-title a').removeClass('toggle');
			$('#accordion .panel-title a').children('img').attr("src","/kuangye/public/home/images/arrow-right.png");
		}
					// 
					if($('#collapseTwo').hasClass('in')){
						$('#accordion01 .panel-title a').addClass('toggle');
						$('#accordion01 .panel-title a').children('img').attr("src","/kuangye/public/home/images/arrow-down.png");
					}
					else{
						$('#accordion01 .panel-title a').removeClass('toggle');
						$('#accordion01 .panel-title a').children('img').attr("src","/kuangye/public/home/images/arrow-right.png");
					}
				})
				// 1
				...
				$('#accordion .panel-title a').click(function(){
					if($(this).hasClass('toggle')){
						...
						$(this).children('img').attr("src","/kuangye/public/home/images/arrow-right.png");
					}else{
						$(this).addClass('toggle');
						$(this).children('img').attr("src","/kuangye/public/home/images/arrow-down.png");
					}
				})
