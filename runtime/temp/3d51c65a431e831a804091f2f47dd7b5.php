<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\phpStudy\PHPTutorial\WWW\kuangye/app/bhadmin\view\index\login.tpl";i:1520413535;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
.gear{ width:166px; height:198px; background:url(/kuangye/public/bhadmin/images/gear-line.png) no-repeat center center; position:absolute; z-index:1; left:460px; top:80px; display:none;} 
...
.i-login .i-logindiv{ width:480px; height:auto; margin:0px auto; overflow:hidden;box-shadow: 0 2px 2px rgba(0,0,0,.05);}
...
.i-alert{ width:500px; height:40px; background:#fff; position:fixed; top:0%; left:50%; margin-top:10px; margin-left:-250px; z-index:300; border-radius:0px; display:none; border-left:solid 2px #ed7876;}
.i-alert div.i-alert-body{ width:480px; height:40px; margin:0px auto; overflow:hidden; line-height:40px; text-align:left; color:#ed7876;}
...
@media (max-width:500px){
 ...
 .i-login .i-logindiv,.i-login .i-loginhead,.i-login .i-loginbody,.i-login .i-loginfoot{ width:100%;}
...
.bhface{ width:140px; height:140px; background:#3d3e3f url('/kuangye/public/bhadmin/images/logo/adminlogo.png') no-repeat center center; background-size:80%; border-radius:50%; border:solid 10px #1f292e; float:left; margin-right:20px; cursor:pointer; position:relative;}
...
<?php if($data['adminpath'] == ''): ?>
 ...
 <div class="i-login">
   <div class="logo"><img src="/kuangye/public/bhadmin/images/logo.png"></div>
 ...
 <!--结束-->     
 <div class="gear"><img src="/kuangye/public/bhadmin/images/gear.png" class="gear-div"></div>
 

 <script type="text/javascript" src="/kuangye/public/bhadmin/js/jquery.min.js"></script>
