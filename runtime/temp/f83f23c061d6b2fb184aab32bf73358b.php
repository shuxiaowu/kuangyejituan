<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye/app/home\view\news\newsinfo.tpl";i:1553313807;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\common.tpl";i:1553325227;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\header.tpl";i:1553328860;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\inside.tpl";i:1553239675;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\home\view\common\footer.tpl";i:1553243640;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
	...
	<div class="main fixed">
		<div class="left leftnav wow fadeInLeft animated">
			<div class="sideMenu">
				...
				<?php if(is_array($newsType) || $newsType instanceof \think\Collection || $newsType instanceof \think\Paginator): $i = 0; $__LIST__ = $newsType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
					<div class="panel-group" id="accordion">
						<div class="panel panel-default">
							<div class="panel-heading <?php if($type == $obj['Id']): ?>active<?php endif; ?>">
								<h4 class="panel-title">
									<a href="<?php echo url('News/newsinfo','type='.$obj['Id']); ?>">
										<?php echo $obj['topic']; ?>
									</a>
								</h4>
							</div>
		...
		<div class="inside-z">电话：<?php echo $sysconf['tel']; ?></div>
			...
			<div class="right-con wow fadeInUp animated">
				<div class="path">
					...
					<div class="pathdiv"> <a href="<?php echo url('Index/index'); ?>">主页</a><span>&gt;</span><a href="<?php echo url('News/newsinfo'); ?>">矿业新闻</a><span>&gt;</span><a href="" class="on"><?php echo $title; ?></a></div>
				</div>
				<div class="rightBox" id="news-neiye">
					<div class="content fixed">
						<?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
							<div class="list-down">

								<a href="#" alt="<?php echo $obj['topic']; ?>" title="<?php echo $obj['topic']; ?>">
									<div class="list-down-item">
										<div class="pull-left leftimg">
											<img src="<?php echo dpic($obj['pic']); ?>" width="100%" height="100%">
											<div class="opacity">
												<img src="/kuangye/public/home/images/hovernew.png">
											</div>
										</div>
										<div class="pull-right meetcon">
											<div class="meettopic"><a href="" alt="<?php echo $obj['topic']; ?>" title="<?php echo $obj['topic']; ?>"><?php echo $obj['topic']; ?></a></div>
											<div class="meetintro"><?php echo $obj['intro']; ?></div>
											<div class="meettime"><?php echo subtext($obj['date'],0,11); ?></div>
										</div>
									</div>
								</a>
							</div>
