<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\phpStudy\PHPTutorial\WWW\kuangye/app/bhadmin\view\online\dataonline.tpl";i:1517363098;s:70:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\bhadmin\view\public\common.tpl";i:1521027423;s:68:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\bhadmin\view\public\meta.tpl";i:1520304810;s:70:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\bhadmin\view\public\footer.tpl";i:1517362582;s:67:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\bhadmin\view\public\pic.tpl";i:1502889310;s:70:"D:\phpStudy\PHPTutorial\WWW\kuangye\app\bhadmin\view\public\editor.tpl";i:1521026953;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="boxed">
 ...
 <div class="panel-heading">
  ...
  <div class="pull-right mar10">
   <div class="btn-group">
   <?php echo btn(array('vals'=>'最近7天','size'=>3,'icon'=>'calendar','scene'=>$scene[0],'round'=>1,'url'=>url('Online/dataonline','act=1&chart='.$chartindex))); ?>
   <?php echo btn(array('vals'=>'最近30天','size'=>3,'icon'=>'calendar','scene'=>$scene[1],'url'=>url('Online/dataonline','act=2&chart='.$chartindex))); ?>
   <?php echo btn(array('vals'=>'本月','size'=>3,'icon'=>'calendar','scene'=>$scene[2],'url'=>url('Online/dataonline','act=3&chart='.$chartindex))); ?>
   <?php echo btn(array('vals'=>'折线图','size'=>3,'faicon'=>'line-chart','scene'=>$chartscene[0],'url'=>url('Online/dataonline','chart=1&act='.$act))); ?>
   <?php echo btn(array('vals'=>'柱型图','size'=>3,'faicon'=>'bar-chart','scene'=>$chartscene[1],'url'=>url('Online/dataonline','chart=2&act='.$act))); ?>
   <?php echo btn(array('vals'=>'面积图','size'=>3,'faicon'=>'area-chart','round'=>1,'scene'=>$chartscene[2],'url'=>url('Online/dataonline','chart=3&act='.$act))); ?>
   </div>
  </div>
 </div>
 ...
 <div class="panel-body">
  ...
  &nbsp;时间段：<input type="text" value="<?php echo $sday; ?>" name="sday" class="textsort input-date">
  至&nbsp;<input type="text" value="<?php echo $eday; ?>" name="eday" class="textsort input-date">
  &nbsp;<?php echo btn(array('vals'=>'查看','type'=>'submit','icon'=>'search','name'=>'searchdata','round'=>1,'scene'=>'primary')); ?>
  </form>
 ...
 <script src="/kuangye/public/bhadmin/js/highcharts.js"></script>
 ...
 <div class="pubmain">
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle(); ?>">
   ...
   <tr>
     ...
     <td align="left" valign="middle"><?php echo !empty($obj['time'])?$obj['time']:'00:00:00'; ?></td>
     ...
     <td align="center" valign="middle"><?php echo btn(array('vals'=>'详细','round'=>1,'faicon'=>'bar-chart-o','scene'=>'primary','url'=>url('Online/onlinedetail','day='.$obj['day']))); ?></td>
   </tr>
   <?php endforeach; endif; else: echo "" ;endif; ?>
   </table>
  </div>
