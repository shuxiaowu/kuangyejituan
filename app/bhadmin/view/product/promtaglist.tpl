...
<block name="main">
 <div class="pubmain">
  <div class="panel-heading">
   ...
   <div class="pull-right mar10">{:btn(array('vals'=>'添加资料','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('Product/promtagadd','sty='.$sty.'&tables='.$dshow['table'])))}</div>
  </div>
 ...
 <form name="pubserch" method="get" action=""> 
  ...
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   ...
   <tr class="maintr">
    ...
    <td align="center" valign="middle">{:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('Product/promtagmod','tables='.$dshow['table'].'&id='.$obj['Id'])))}</td>
   </tr>
   </volist>
   <tr>
