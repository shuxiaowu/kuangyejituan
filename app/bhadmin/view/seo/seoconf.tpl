   ...
   <form name="sysmod" method="post" action="">
    ...
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
      ...
      <tr>
        ...
        <td align="left" valign="middle">{:inputs(array('name'=>'articleurl','val'=>$data['articleurl'],'place'=>'文章的url, 例如：http://www.jxbh.cn/article/[id].html'))}</td>
      </tr>
      <tr>
        ...
        <td align="left" valign="middle">{:inputs(array('name'=>'marticleurl','val'=>$data['marticleurl'],'place'=>'手机站文章的url, 例如：http://m.jxbh.cn/article/[id].html'))}</td>
      </tr>    
      <tr>
        <td align="left" valign="middle">MIP提交Url:<br/><font style="color:#999; font-size:12px;"><a href="http://www.jxbht.com/article/210.html"{:tooltip('点击跳转至百恒网络')}target="_blank" style="color:#f60;">点击查看如何获取？</a></font></td>
        <td align="left" valign="middle">{:inputs(array('name'=>'mipurl','val'=>$data['mipurl'],'width'=>60,'place'=>'MIP提交的url'))}</td>
      </tr>
      <tr>
        <td align="left" valign="middle">百度主动推送Url:<br/><font style="color:#999; font-size:12px;"><a href="http://www.jxbht.com/article/210.html"{:tooltip('点击跳转至百恒网络')} target="_blank" style="color:#f60;">点击查看如何获取？</a></font></td>
