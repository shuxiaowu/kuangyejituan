...
<block name="main">
 <div class="pubmain">
  <div class="panel-heading">
   ...
   <div class="pull-right mar10">{:btn(array('vals'=>'添加类别','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('website/datatypeadd','tables='.$dshow['table'].'&sty='.$sty)))}</div>
  </div>
  ...
  <tr class="maintr">
    ...
    <td align="center" valign="middle">{:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('datatypemod','tables='.$dshow['table'].'&id='.$obj['Id'])))}
    </td>
   </tr>
  </volist>
  <tr>
