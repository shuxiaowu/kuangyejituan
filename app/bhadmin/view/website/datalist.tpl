...
<block name="main">
 <div class="pubmain">
  <div class="panel-heading">
   ...
   <div class="pull-right mar10">{:btn(array('vals'=>'添加资料','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('website/dataadd','sty='.$sty.'&tables='.$dshow['table'].'&martables='.$dshow['martable'])))}</div>
  </div>
  ...
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   ...
   <tr class="maintr">
    ...
    <td align="center" valign="middle">
     ...
     {:btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','round'=>1,'url'=>url('website/datamod','tables='.$dshow['table'].'&martables='.$dshow['martable'].'&id='.$obj['Id'])))}
    </td>
   </tr>
   </volist>
   <tr>
