...
<head>
 ...
 <meta name="description" content="{:config('devcompany')}CMS {:config('admin_version')}">
 <meta name="keywords" content="{:config('devcompany')}CMS {:config('admin_version')}">
 <meta name="author" content="jxbh">
 <title>{:config('devcompany')}CMS</title>
<style>
...
.bhface{ width:140px; height:140px; background:#3d3e3f url('__img__/logo/adminlogo.png') no-repeat center center; background-size:80%; border-radius:50%; border:solid 10px #1f292e; float:left; margin-right:20px; cursor:pointer; position:relative;}
...
<if condition="$data['adminpath'] eq ''">
 ...
 <else/>
   <div class="lockscreen">
     ...
     <div class="bhlist">
       <p class="h2" style="margin-top:35px;">{:config('devcompany')}提醒您！</p>
